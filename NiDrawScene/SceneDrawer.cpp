...
//		printf("Initialized depth texture: width = %d, height = %d\n", texWidth, texHeight);
	...
	if (g_bPrintFrameID)
	{
        ...
        //when detect falling, dispaly the text " Falling Detected "
        if(fallDetected==true){     
                char falldetected[50] = "    Falling Detected    ";
                glPrintString(GLUT_BITMAP_TIMES_ROMAN_24, falldetected);
                 }
}

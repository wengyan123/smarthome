...
//value fallDetected,when it receive the signal SIGUSR1 from the program fall detection,it will set this boolean to true
bool fallDetected=false;
extern void glPrintString(void *font, char *str);
//---------------------------------------------------------------------------
// Code
//---------------------------------------------------------------------------

//signal handler, to treat signal SIGUSR1 and set falldetected 
void falldetected_handler(int sig){
  printf("SceneDrawer:***********falling detected!!!!**********************\n");
  fallDetected=true;
}
...
int main(int argc, char **argv)
{
 ...
 //***************************************************************       
   // capture signal      
   signal(SIGUSR1,falldetected_handler);      
